...
define('DB_PASSWORD', 'Hezrid56610');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '.KEE{~!D/]<kJ9x(Eyk2j{{Qphl}>D?5oQN7RCOdzY/a>&}qlQ7<eS#V4*?Z5n%X');
define('SECURE_AUTH_KEY',  'm!cY;sJbFes}Fr>b8qUyZ#0[knyCf<aomP~z=[mS+B^C+##nGTIH+&&W0#*&tKmv');
define('LOGGED_IN_KEY',    'i,.Z]PKzV]%,7bzdI}A|56#xv%4P(oTs;%yA$3XDHl{zyEiKbh}X/farLJ!n4VN_');
define('NONCE_KEY',        'Km;wsyo1%k4{T%vNf(sy1$ g;R3Vav~5wul zZV`?f?YP$w$5&Ng_TZB,=Q|i>iN');
define('AUTH_SALT',        'K.K~_68]G[|t3BvG3<qmR@ttIDgP0 As7Lu}X;eR4_v<N~+#1HbpKghRe0t8FBDp');
define('SECURE_AUTH_SALT', 'ivF`_N8|0xm6aIorK~Cws`k<4jk 43{3@/F`ZbNPXdHedE~j]::kNp6p^3X&RK.m');
define('LOGGED_IN_SALT',   'A9rj)v Tnnh*`.x{{cDUJ|bWgR`yI:Haj<;_/vnv6wex6]V~mXGghz|y78`P8;nv');
define('NONCE_SALT',       'B4O_3=uOiW$oa7wMRlEWdg hB^f~D1=|i3Ot&G7%5AXd(uy/~2*yF(3KPc[5|w9U');
...
define('WP_HOME','https://test.nodejs-tw.org');
define('WP_SITEURL','https://test.nodejs-tw.org');
